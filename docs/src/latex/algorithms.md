...
```
<img src="https://github.com/log-ufpb/qr/blob/main/latex/algorithms/eq6.png" width="70%" height="70%">
...
<img src="https://github.com/log-ufpb/qr/blob/main/latex/algorithms/eq7.png" width="70%" height="70%">
...
\end{lstlisting}
```
<img src="https://github.com/log-ufpb/qr/blob/main/latex/algorithms/eq8.png" width="70%" height="70%">
